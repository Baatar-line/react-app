...
import { SUGGESTS, SUGGEST_COLLECTIONS, imgUrl } from '../data';
...
export default function SuggestDetail() {
  ...
  return (
    <section data-screen-label="Санал болгох дэлгэрэнгүй" style={css('padding:110px 48px 60px;min-height:100vh;box-sizing:border-box')}>
      <Hover as="button" onClick={() => navigate('/suggest')} s="all:unset;cursor:pointer;display:inline-flex;align-items:center;gap:8px;font-size:13px;font-weight:600;color:rgba(242,237,227,.6);margin-bottom:26px;transition:color .25s" h="color:var(--accent,#E8B84B)">← {L.suggestTitle}</Hover>
