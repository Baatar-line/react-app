...
import { AIMAGS, AIMAG_BG, CATS, SUGGESTS, SUGGEST_COLLECTIONS, SuggestCollectionItem, U, imgUrl, isVideoUrl } from './bigbang/data';
import CreateForm, { CreateFormData, CreateKind } from './shared/CreateForm';
