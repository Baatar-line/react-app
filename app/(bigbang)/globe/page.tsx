    ...
    >
      ...
      <div className="absolute left-12 top-[88px] z-[6] flex flex-col gap-8">
        ...
        {V.globeHasCard && leftSites.length > 0 && (
          <div className="z-[8] flex w-[250px] flex-col gap-[10px]">
